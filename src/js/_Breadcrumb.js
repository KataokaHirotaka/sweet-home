export default class Breadcrumb {
  ...
  createBreadcrumbHtml() {
    ...
    if (this.path === "/news" || this.path === "/news/") {
      breadcrumbHTML += `
      ...
      `;
    } else if (this.path === "/info/" || this.path === "/info") {
      breadcrumbHTML += `
          <li class="l-breadcrumbList_item visited"><a href="/" class="icon"></a></li>
          <li class="l-breadcrumbList_item">&nbsp;&gt;&nbsp;ご案内</li>
      `;
    } else if (this.path === "/info/price/" || this.path === "/info/price") {
      breadcrumbHTML += `
        <li class="l-breadcrumbList_item visited"><a href="/" class="icon"></a></li>
      ...
      this.path === "/info/price/temporary/" ||
      this.path === "/info/price/temporary"
    ) {
      breadcrumbHTML += `
      <li class="l-breadcrumbList_item visited"><a href="/" class="icon"></a></li>
